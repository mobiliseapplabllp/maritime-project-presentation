...
const Pre = ({ data }) => (
  <Box component="pre" sx={{
    m: 0, p: 1.5, borderRadius: 1.5, fontSize: 11.5, lineHeight: 1.5, overflow: 'auto', maxHeight: 420,
    fontFamily: '"IBM Plex Mono",monospace',
    bgcolor: (t) => (t.palette.mode === 'dark' ? '#081B26' : '#F4F7F6'),
...
export default function JsonDialog({ open, onClose, title, before, after }) {
