  ...
  return createTheme({
    ...
    components: {
      ...
      MuiCard: {
        ...
        styleOverrides: { root: { border: `1px solid ${dark ? '#1C3F4F' : '#D8E2E2'}` } },
      },
      MuiTableCell: {
        styleOverrides: {
          ...
          head: {
            ...
            color: dark ? '#89A5B0' : '#5A7280', whiteSpace: 'nowrap',
            backgroundColor: dark ? '#102D3B' : '#EEF2F1',
          },
        },
      },
...
// Validated categorical palettes (dataviz six checks, light surface #FFFFFF / dark #0C2330).
// Fixed order: container, dryBulk, liquid, other — never cycled, never re-ranked.
...
// Platform signature gradient (blue -> purple -> magenta)
export const BRAND_GRADIENT = 'linear-gradient(100deg,#0B74B0 0%,#75479C 55%,#BD3861 100%)';
export const BRAND = { blue: '#0B74B0', purple: '#75479C', magenta: '#BD3861' };
