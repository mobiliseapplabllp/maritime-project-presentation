...
// An instrument's life is a one-way street: a draft is put in force, an
// in-force instrument is superseded or withdrawn, and neither of those comes
// back. Enforced server-side the same way port-call status is, so the register
// cannot be walked backwards through the API or the UI.
...
module.exports = {
  ...
  INSTRUMENT_TYPES, INSTRUMENT_STATUS, INSTRUMENT_TRANSITIONS,
