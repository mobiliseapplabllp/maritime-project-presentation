...
exports.create = async (req, res) => {
  ...
  const user = await User.create({
    name, email, role, designation: designation || '', phone: phone || '',
...
exports.update = async (req, res) => {
  ...
  const { name, email, role, designation, phone, active } = req.body || {};
  ...
  Object.assign(user, {
    ...
    ...(role !== undefined && { role }), ...(designation !== undefined && { designation }),
