...
const PROMPTS = [
  ...
  "Write a PSC-compliance assessment of the vessels calling at the port.",
...
const PROMPTS_DOCS = [
  "What are the monsoon UKC and pilotage restrictions at the port?",
...
<div class="brand"><div class="mk">◈</div><div><div class="t">Sagar Drishti</div>
  <div class="s">${t("Maritime AI Analytics · Reference deployment")}</div></div></div>
<div class="meta">${t("Sagar Intelligence report · generated {date} · port operations panels (read-only, berth level)", { date })}</div>
${body}
      ...
      <div className="asst-head-row">
        <div>
          <PageHeader
            ...
            sub={t("Ask in plain language and Sagar Intelligence prepares a formatted report from the live Port Authority data — rankings, comparisons, benchmark and receivables assessments, briefings.")}
          />
        </div>
                      ...
                      <div className="asst-report-foot">
                        <span className="mono">
                          {m.mode === "docs"
                            ...
                            : t("Generated by Sagar Intelligence · from live Port Authority data")}
                        </span>
                        {ttsSupported && (
